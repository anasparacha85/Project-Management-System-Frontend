  ...
  return (
    <div className="team-container">
      <div className="team-header">
        <h1 className="team-title">Assigned members ({taskDetails.assignees.length})</h1>
        <p className="team-subtitle">members assigned to {taskDetails.title}</p>
      </div>
