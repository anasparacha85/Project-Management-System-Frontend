...
import { fetchTasksById } from "../../Slices/TaskSlice";
...
const handleUpload = async () => {
  ...
  try {
    ...
    const data = await ApiServices.uploadFilesBytaskId(formData, params.id);
        ...
        <div className="flex items-start justify-between gap-6">
          ...
          <div className="flex gap-6">
            <div className="text-center px-5 py-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
              <span className="block text-2xl font-bold text-blue-800">{taskDetails?.attachments?.length || 0}</span>
